...
*/
	...
	$gagal="select d.kod_status_kelulusan
				...
				and d.id_penilaian=(select max(b.id_penilaian) from usr_isac.pro_peserta a,usr_isac.prs_penilaian_peserta b where a.id_peserta=b.id_peserta and (a.no_kad_pengenalan='".$_POST['publicID']."' or a.no_kad_pengenalan_lain='".$_POST['publicID']."') )";
