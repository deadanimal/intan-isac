...
$sql_check = "select * from usr_isac.prs_penilaian_peserta_kemahiran where id_peserta = '".$id_peserta."' and kod_bahagian_soalan='03'";
$result_check = $myQuery->query($sql_check,'SELECT');
	...
	$sql = "insert into usr_isac.prs_penilaian_peserta_kemahiran (id_peserta,fail_jawapan_peserta,kod_bahagian_soalan) values ('".$id_peserta."','".$ans_file."','03')";
...
{
myApp.Visible = true;
obj=myApp.Presentations.Open("\\\\<?php echo $location;?>\\xampp\\htdocs\\isac\\kemahiran\\<?php echo $fileDest;?>");
}
this.close();
