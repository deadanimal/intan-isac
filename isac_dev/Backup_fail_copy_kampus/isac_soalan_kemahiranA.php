...
//internet
windowOne=window.open('isac_soalan_kemahiranA_internet1.php?id=<?php echo $usr;?>&app=<?php echo $app;?>','answer','height=480,width=1400,top=0, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
//internet_question
windowTwo=window.open('isac_soalan_kemahiranA_internet.php?id=<?php echo $usr;?>&app=<?php echo $app;?>','question','height=180,width=1400,left=0,top=640, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
