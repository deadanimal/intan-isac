...
define('DB_CONNECTION','localhost');			//for mysql only
define('DB_DATABASE','fareeda_mysql');
define('DB_USERNAME','root');
define('DB_PASSWORD','');
define('DB_OTHERS','customer');

//constants definition
define('SESSION_NAME','FAREEDA_DEMO');
define('SYSTEM_NAME','FAREEDA_DEMO');
define('SYSTEM_FULL_NAME','FAREEDA');
define('SYSTEM_VERSION','2.2');
define('SYSTEM_BUILD','0509');
...
define('FOOTER_TEXT','Copyright 2009. EsRA Technology Sdn Bhd');
define('FOOTER_CLASS','');
define('FOOTER_ID','footer');

//bottom links
define('BOTTOM_LINKS_ENABLED',true);			//true/false
define('BOTTOM_LINKS_CLASS','');
define('BOTTOM_LINKS_ID','bottomLinks');

//bottom text
define('BOTTOM_TEXT_ENABLED',true);				//true/false
