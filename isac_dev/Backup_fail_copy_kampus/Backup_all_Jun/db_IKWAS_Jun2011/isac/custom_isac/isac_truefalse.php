<?php
$soalan = "select penyataan_soalan,arahan_soalan from usr_isac.pro_soalan where id_soalan = '459'";
$prosoalan = mysql_query($soalan) or die('Error, query failed');
$prosoalanRs = mysql_fetch_array($prosoalan);

$query="select keterangan_jawapan from usr_isac.pro_pilihan_jawapan where id_soalan = '459'";
	...
	?>&nbsp;</td>
             ...
             <tr>
               ...
               <td width="94%"><table width="100%" border="0">
                 ...
                 <tr>
                   <td width="3%"><input name="radiobutton" type="radio" value="radiobutton" /></td>
