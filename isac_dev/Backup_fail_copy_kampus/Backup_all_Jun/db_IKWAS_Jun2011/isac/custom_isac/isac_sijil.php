...
<table width="100%" border="0">
  ...
  <tr>
    <td height="240" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="6" class=""><div align="center" class="style36"><?php echo $newdate.' '.$newmonth.' '.$newyear; ?> </div></td>
  </tr>
  <tr>
    <td height="38" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
    <td width="4%" class="style3">&nbsp;</td>
    <td width="5%" class="style3">&nbsp;</td>
    <td width="41%" class="style3"><div align="left"></div></td>
    <td width="30%" class="style3"><div align="right"><br />
    </div></td>
    <td width="9%" class="style3"><img src="SignDrM.jpg" width="120" height="81" align="middle" /></td>
    <td width="11%" class="style36">&nbsp;</td>
  </tr>
  <tr>
    <td height="29" class="style3">&nbsp;</td>
    <td colspan="2" class="style3"><div align="right" class="style38">
      <div align="left" class="style39"></div>
    </div></td>
    <td colspan="2" class="style37"><div align="right" class="style37"><strong>DR. MAZLAN BIN HARUN</strong></div></td>
    <td class="style3">&nbsp;</td>
  </tr>
</table>
