  ...
  <tr>
    <td ><table width="100%" border="0">
      ...
      <table width="850" border="0" align="center">
          ...
          <tr>
            <td colspan="3" class="style54"><p align="left" class="style54"> 2. Adalah dimaklumkan bahawa pegawai tuan/puan telah ditawarkan untuk menduduki ujian Penilaian ICT </p></td>
          </tr>
          <tr>
            <td colspan="3" class="style54">&nbsp;</td>
          </tr>
          <tr>
            <td colspan="3" class="style54">Skills  Assessment and Certification (ISAC). Maklumat lengkap ujian adalah seperti berikut :-</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" class="style54" height="30px" valign="bottom">3. Sekiranya tuan/puan tidak dapat hadir pada tarikh penilaian, sila beri penjelasan melalui emel </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" class="style54"> akan mengakibatkan nama tuan/puan *DISENARAIHITAMKAN* daripada menduduki ujian penilaian </td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" class="style54">Sebarang kemusykilan/masalah, sila hubungi kami melalui emel: isachelp@intanbk.intan.my.</td>
          </tr>
          <tr>
            <td colspan="3" class="style54">&nbsp;</td>
          </tr>
      ...
      <table width="100%" border="0">
          <tr>
           ...
           <strong class="style55">SUKIMAN BIN HASSAN </strong>
            <br/>
              Ketua Unit Latihan Pembudayaan ICT dan Kerjaya <br />
              Pusat Pembangunan Strategis ICT <br />              
			  Bahagian Teknologi Pengurusan (IMATEC) <br />
