...
{	
	...
	{
		return @mysql_query($sql,$this->dbc) or die('DATABASE INSERT, UPDATE, DELETE QUERY ERROR: '.mysql_error());	//run query
	}
	...
	{	
		$sqlRs = @mysql_query(strtoupper($sql),$this->dbc) or die('DATABASE SELECT QUERY ERROR: '.mysql_error());	//run query
