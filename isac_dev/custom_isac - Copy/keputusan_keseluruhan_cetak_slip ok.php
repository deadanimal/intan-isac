...
.style51 {font-family: "Times New Roman"; }
...
<tr class="style15">
     <td height="29"><table width="736" border="0" align="left">
       <tr>
         <td width="730"><p align="left"><?php echo $gelaran; ?><br />
           <?php if empty($bahagian) {
			continue;} else {echo $bahagian;} ?><br />
           <?php if empty($jabatan) {
			continue;} else echo $jabatan; ?><br />
           <?php echo $kementerian; ?><br />
           <?php echo $alamat1; ?><br />
           <?php if empty($alamat2) {
			continue;} else echo $alamat2; ?><br />
           <?php if empty($alamat3) {
			continue;} else echo $alamat3; ?><br />
           <?php echo $poskod;?> <?php echo $bandar; ?><br />
           (up : <?php echo $penyelia; ?>)</p>
           <p align="left">Tuan/Puan,<br />
               <strong>Keputusan  ICT Skills Assessment And Certification (ISAC)</strong><br />
             </p>
           <p align="left">Adalah saya dengan hormatnya merujuk perkara di atas. </p>
          <p align="left">2. Sukacita disertakan keputusan penilaian ISAC yang telah diduduki oleh pegawai dari jabatan tuan seperti berikut :-<u></u></p></td>
       </tr>
   ...
   <tr>
     <td height="29"><table width="850" border="0" align="center">
       ...
       <tr>
         ...
         <td width="18%" class="style31"><div align="left" class="style51"><span class="style4 style44 style47">Nama</span></div></td>
         <td width="1%"><div align="center"><strong>:</strong></div></td>
         <td width="75%"><span class="style13"><?php echo $nama; ?></span></td>
       </tr>
       <tr>
         <td class="style31">&nbsp;</td>
         <td class="style31"><div align="left" class="style51"><span class="style4 style44 style47">No. MyKad</span></div></td>
         <td><div align="center"><strong>:</strong></div></td>
         <td><span class="style13"><?php echo $ic; ?></span></td>
       </tr>
       <tr>
         <td class="style31">&nbsp;</td>
         <td class="style31"><div align="left" class="style51"><span class="style4 style44 style47">Tarikh Penilaian</span></div></td>
         <td><div align="center"><strong>:</strong></div></td>
         <td><span class="style13"><?php echo $tarikh; ?></span></td>
       </tr>
       <tr>
         <td class="style31">&nbsp;</td>
         <td class="style31"><div align="left" class="style51"><span class="style4 style44 style47 ">Tahap Penilaian</span></div></td>
         <td><div align="center"><strong>:</strong></div></td>
         <td><span class="style27"><?php echo $tahap; ?></span></td>
       </tr>
       <tr>
         <td class="style31">&nbsp;</td>
         <td class="style31"><div align="left" class="style51">Lokasi</div></td>
         <td><div align="center"><strong>:</strong></div></td>
...
?>
       ...
       <table width="540" border="1" bordercolor="#999999">
         ...
         <tr>
           ...
           <td><div align="center"><span class="style27"><?php echo $tahap_pengetahuan;?></span></div></td>
         </tr>
         <tr>
           ...
           <td><table width="300" border="0">
             <tr>
               ...
               <td width="150"><span class="style27"><?php echo $tahap_internet;?></span></td>
             </tr>
             <tr>
...
?>
             ...
             <tr>
               ...
               <td><strong>:</strong></td>
               <td><span class="style27"><?php echo $tahap_outlook; ?></span></td>
             </tr>
           </table></td>
         </tr>
         <tr>
           <td bgcolor="#E4E4E4"><div align="center" class="style53">Keseluruhan</div></td>
           <td bgcolor="#E4E4E4"><div align="center"><span class="style27">
             <?php 
$all_result = "select 
...
?>
         ...
         <tr>
           ...
           <td bgcolor="#E4E4E4">
             <div align="center" class="style27"><?php if ($status_kelulusan== 'Lulus') { ?>
               <?php
...
?>
       ...
       <table width="747" border="0">
         <tr>
           <td width="737"><p>&nbsp;</p>
             <p>3. Bersama-sama  ini disertakan sijil bagi atas nama kakitangan yang telah lulus penilaian  tersebut.<br clear="all" />
             </p>
             <p>4. Pihak kami mengucapkan ribuan terima kasih  ke atas kerjasama pihak tuan dalam menjayakan program ISAC ini.<br />
             </p>
             <p>&nbsp;</p>
             <p>Sekian. <br />
               &nbsp; </p>
             ...
             <h1 class="style47">&nbsp;</h1>
             <h1 class="style47">&nbsp;</h1>
             <h1 class="style47">MOGHIRATUNNAJAT  HJ ZAKARIA</h1>
           <h1 class="style47">Institut Tadbiran  Awam Negara (INTAN Bukit Kiara)</h1></td>
         </tr>
       </table>       <p>&nbsp;</p>
     </td>
   </tr>
