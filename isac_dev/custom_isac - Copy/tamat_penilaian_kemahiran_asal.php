...
and a.id_peserta = '$usr' and markah='1'";
...
b.id_pemilihan_soalan = (select max(id_pemilihan_soalan) from usr_isac.pro_pemilihan_soalan)
and a.id_peserta = '$usr' and markah='0'";
...
$sql_jumk= "select jumlah_keseluruhan_soalan,nilai_markah_lulus from usr_isac.pro_pemilihan_soalan where id_pemilihan_soalan = (select max(id_pemilihan_soalan) from usr_isac.pro_pemilihan_soalan)";
...
$sql_check = "select id_penilaian_keputusan_bahagian,
				   (SELECT description1 FROM isac.refgeneral 
					...
					from usr_isac.prs_penilaian_keputusan_bahagian where id_peserta = '".$usr."' and kod_bahagian_soalan='05'";
...
if ($correct_answer >= $status_pengetahuan)
		{
			...
			{
			//echo 'Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian,tahap_status) values ('".$usr."','05','01','01')";
		...
		else
		{
			...
			{
			//echo 'Tidak Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','05','02')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
//echo $status;
...
$sql_check = "select id_penilaian_keputusan_bahagian,
					...
					referencestatuscode='00' 
					AND referencecode=kod_status_penilaian_bahagian) 
					from usr_isac.prs_penilaian_keputusan_bahagian where id_peserta = '".$usr."' and kod_bahagian_soalan='01'";
$checkRs = $myQuery->query($sql_check,'SELECT');
$status = $checkRs[0][1];
if ($part_internet >= $status_internet)
		{
			...
			{
			//echo 'Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian,tahap_status) values ('".$usr."','01','01','01')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
		else
		{
			...
			{
			//echo 'Tidak Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','01','02')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
//echo $status;
...
$sql_check = "select id_penilaian_keputusan_bahagian,
					...
					from usr_isac.prs_penilaian_keputusan_bahagian where id_peserta = '".$usr."' and kod_bahagian_soalan='02'";
$checkRs = $myQuery->query($sql_check,'SELECT');
$status = $checkRs[0][2];
		if ($part_word >= $status_word)
		{
			...
			{
			//echo 'Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','02','01')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
		else
		{
			...
			{
			//echo 'Tidak Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','02','02')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
//echo $status;
...
$sql_check2 = "select id_penilaian_keputusan_bahagian,
					...
					referencestatuscode='00' 
					AND referencecode=kod_status_penilaian_bahagian),kod_status_penilaian_bahagian
					from usr_isac.prs_penilaian_keputusan_bahagian where id_peserta = '".$usr."' and kod_bahagian_soalan='03'";
...
$status2 = $checkRs2[0][2];
		if ($part_ppoint >= $status_ppoint)
		{
			...
			{
			//echo 'Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','03','01')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
		else
		{
			...
			{
			//echo 'Tidak Melepasi';
			$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','03','02')";
			$result = $myQuery->query($sql,'RUN');
			}
		}
...
$sql_check = "select id_penilaian_keputusan_bahagian, 
					...
					referencestatuscode='00' 
					AND referencecode=kod_status_penilaian_bahagian) 
					from usr_isac.prs_penilaian_keputusan_bahagian where id_peserta = '".$usr."' and kod_bahagian_soalan='04'";
$checkRs = $myQuery->query($sql_check,'SELECT');
$status = $checkRs[0][1];
...
if(count($ansRs)!=0)
{
		...
		if (($to !='0')&&($attach !='0'))
		{
				...
				{
				//echo 'Melepasi';
				$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian,tahap_status) values ('".$usr."','04','01','01')";
				$result = $myQuery->query($sql,'RUN');
				}
		}
		else
		{
				...
				{
				//echo 'Tidak Melepasi';
				$sql = "insert into usr_isac.prs_penilaian_keputusan_bahagian (id_peserta,kod_bahagian_soalan,kod_status_penilaian_bahagian) values ('".$usr."','04','02')";
				$result = $myQuery->query($sql,'RUN');
				}
		}
}
else
{
				...
				{
				$sql = "update usr_isac.prs_penilaian_keputusan_bahagian set kod_bahagian_soalan='04',kod_status_penilaian_bahagian='02' where id_peserta='".$usr."'";
				$result = $myQuery->query($sql,'RUN');
       ...
       <tr>
         <td><p align="center" class="style32">&nbsp;</p>
          <table width="60%" border="0" align="center">
            <tr>
              <td><p class="style32">Penilaian <em>IT Skill Assessment and Certification</em> (ISAC) Tamat.</p>
                <p class="style32">&nbsp;</p></td>
            </tr>
            <tr>
              <td><span class="style32">Berikut merupakan keputusan Penilaian  <em>IT Skill Assessment and Certification</em> (ISAC) :-</span></td>
            </tr>
            <tr>
...
<?php
	...
	{
	echo 'Melepasi';
	$sql_tahap = "update usr_isac.prs_penilaian_keputusan_bahagian set tahap_status='01' where id_peserta='".$usr."' and kod_bahagian_soalan='02'";
...
$all_result = "	select 
					...
					from usr_isac.prs_penilaian_keputusan_bahagian
					where id_peserta = '$usr'";
$allRs = $myQuery->query($all_result,'SELECT','NAME');
$status_kelulusan = $allRs[0]["STATUS"];

$sql_check = "select id_penilaian_peserta,kod_status_kelulusan from usr_isac.prs_penilaian_peserta where id_peserta = '".$usr."'";
$checkRs = $myQuery->query($sql_check,'SELECT');
$result = $checkRs [0][1];
/*if($result=='')
{*/
	$sql = "update usr_isac.prs_penilaian_peserta set kod_status_kelulusan='".$status_kelulusan."' where id_peserta = '".$usr."'";
	$result = $myQuery->query($sql,'RUN');
//}
...
$kelulusan = $result[0][0];
	...
	$checkKodIAC = "select 
					d.kod_iac 
					from usr_isac.pro_peserta a, usr_isac.prs_penilaian_peserta b, usr_isac.prs_penilaian c, usr_isac.pro_sesi d
					where a.id_peserta = b.id_peserta and b.id_penilaian = c.id_penilaian and c.id_sesi = d.id_sesi 
					and a.id_peserta = '".$usr."'";
	...
	$sql = "insert into usr_isac.pro_sijil(id_peserta,no_sijil,kod_iac) values ('".$usr."','".$noSijil."','".$kodIAC."')";
