...
<iframe id="objektif" name="objektif"  src="custom_isac/soalan_perincian1.php?usr=<?php echo $usr ;?>" frameborder="0" width="100%" height="1700px" allowTransparency="true"></iframe>	
