...
$query = "SELECT (SELECT description1 FROM refgeneral 
				...
				FROM usr_isac.pro_sesi WHERE kod_kategori_peserta='01' and id_sesi !='351' and id_sesi !='395'" .
...
$query = "SELECT COUNT(id_sesi) AS numrows FROM usr_isac.pro_sesi where kod_kategori_peserta='01' and id_sesi !='351' and id_sesi !='395'";
$result = mysql_query($query) or die('Error, query failed');
...
?>
                &nbsp;</td>
              <td width="43" height="25" class="style2">&nbsp;</td>
            </tr>
          </table>
<?php	
}
