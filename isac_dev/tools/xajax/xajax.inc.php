...
class xajax
{
	 ...
	 */
	function printJavascript($sJsURI="tools/xajax/", $sJsFile="xajax_js/xajax.js")
	{
	 ...
	 * @return string
	 */
	function getJavascript($sJsURI="tools/xajax/", $sJsFile=NULL)
	{	
	 ...
	 * @return string
	 */
	function getJavascriptInclude($sJsURI="xajax/", $sJsFile=NULL)
	{
