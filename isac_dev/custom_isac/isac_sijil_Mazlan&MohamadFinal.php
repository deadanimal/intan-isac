...
<table width="100%" border="0">
  ...
  <tr>
    <td height="49" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
    <td width="2%" class="style3">&nbsp;</td>
    <td width="7%" class="style3">&nbsp;</td>
    <td width="41%" class="style3"><div align="left"><img src="image/tt dr mohamed.JPG" width="150" height="55" /></div></td>
    <td width="37%" class="style3"><div align="right"><img src="image/SignDrM.JPG" width="80" height="55" /><br />
    </div></td>
    <td width="7%" class="style3">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="2" class="style3"><div align="right" class="style38">
      <div align="left" class="style39">DATO' DR. MUHAMAD BIN HAMZAH</div>
    </div></td>
