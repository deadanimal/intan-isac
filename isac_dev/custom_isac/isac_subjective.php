<?php
$soalan = "select penyataan_soalan,arahan_soalan from usr_isac.pro_soalan where id_soalan = '458'";
$prosoalan = mysql_query($soalan) or die('Error, query failed');
$prosoalanRs = mysql_fetch_array($prosoalan);

$query="select keterangan_jawapan from usr_isac.pro_pilihan_jawapan where id_soalan = '458'";
