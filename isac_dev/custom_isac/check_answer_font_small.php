...
//ni function nak papar data vertical
...
<script type="text/javascript">
	  function confirmation() 
	  {
		...
		if (answer)
		{
			window.location.href = "isac_soalan_kemahiranA.php?id=<?php echo $usr;?>";
		}
...
<form action="isac_soalan_kemahiranA.php?id=<?php echo $usr;?>" method="post" name="mine" class="style2">
...
for($x=0;$x<count($id_soalan);$x++)
{
	...
	{
	$answered = "<a href='soalan_perincian1.php?page=".($x+1)."&submit=true&usr=$usr'><span style='color:blue;font-size:13px;'><u>Telah Dijawab</u></span></a>";
	$icon = "green.png";
	}
	
	else
	{
	$answered = "<a href='soalan_perincian1.php?page=".($x+1)."&submit=true&usr=$usr'><span style='color:red;font-size:13px;'><u>Belum Dijawab</u></span></a>";
	$icon = "red.png";
	}
