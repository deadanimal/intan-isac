...
function confirmation() 
{
	...
	if (answer)
	{
		//parent.location.href = "../index.php?page=page_wrapper&menuID=6268&id=<?php echo $usr;?>&app=<?php echo $app;?>";
		//window.top.location.href = "../index.php?page=page_wrapper&menuID=6268&id=<?php echo $usr;?>&app=<?php echo $app;?>";
...
function confirmation2(id,app){
	
	var jQ = jQuery.noConflict();
	var url = "proses_tamat_penilaian.php";
	...
	jQ.ajax({
				...
				success: function(data){
					window.top.location.href = "../index.php?page=page_wrapper&menuID=6268&id="+id+"&app="+app;
				}
	});
...
<table id="tableContent" cellspacing="0" cellpadding="0" border="0" width="100%">
 ...
 <input style="margin-right:3px" onclick="displaymessage()" type="button" value="Microsoft Outlook" class="inputButton" />          
...
<!-- <input style="margin-right:3px" onclick="window.location='isac_soalan_kemahiranEnd.php?id=<?php /*echo $usr*/;?>'" type="button" value="Tamat" class="inputButton" /> -->
        ...
        <div id="userNotification3" align="right"><span class="style17">* Nota : Anda hanya boleh 'Hantar' setelah selesai manjawab Bahagian C (Outlook).</span>
          <input style="margin-right:3px" onclick="confirmation2(<?php echo $usr; ?>,<?php echo $app; ?>)"  type="button" value="Hantar" class="inputButton" />
        </div></td>
       </tr>
     </table></td>
  </tr>
