     ...
     <td height="29" colspan="3"><p class="style69">&nbsp;</p>
       <table width="856" border="0" align="left">
         ...
         <td width="850"><p align="left" class="style54 style75"><?php echo $gelaran; ?><br />
            <?php if ($jabatan!=""){
			echo ucwords(strtolower($jabatan));?><br /><?php } ?>
			<?php if($kod_kementerian!='129' and $kod_kementerian!='372' and $kod_kementerian!='492') {
			  echo ucwords(strtolower($kementerian)); ?><br /><?php } ?>
			<?php if($bahagian!="") {
			  echo ucwords(strtolower($bahagian)); ?><br /><?php } ?>
              <?php echo ucwords(strtolower($alamat1)); ?><br />
              <?php if($alamat2!="") {
			  echo ucwords(strtolower($alamat2)); ?><br /><?php }?>
			  <?php if($alamat3!="") {
			  echo ucwords(strtolower($alamat3)); ?><br /><?php } ?>
              <?php echo $poskod; ?>,
		      <?php echo ucwords(strtolower($bandar)); ?><br />
			  <?php echo ucwords(strtolower($negeri)); ?><br />
              (<strong>up : <?php echo ucwords(strtolower($penyelia)); ?></strong>)</p>
...
<br>
3. Salinan slip keputusan ini boleh diambil kira dalam hal-hal berkaitan perkhidmatan. Bagi tujuan pengesahan ketulenan keputusan, Ketua Jabatan hendaklah menyemak keputusan dari laman web INTAN di http://www.intanbk.intan.my . <br clear="all" />
             </p>
...
&nbsp; </p>
         ...
         <tr>
           <td width="691" height="112"><h1 class="style55">"JPA Peneraju Perubahan Perkhidmatan Awam"</h1>
             <h1 class="style55">"1 Sentiasa di Hadapan"</h1>             <span class="style55"><strong>En. Sukiman Hassan</strong><br/>
