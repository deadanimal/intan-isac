...
<body>
  <tr>
    <td colspan="3"><img src="internet/knowledge_economy/KE_header2.png" width="1364" height="92" border="0" usemap="#Map" />
<map name="Map" id="Map">
<area shape="rect" coords="3,0,33,34" href="isac_soalan_kemahiranA_internet3_ke.php?id=<?php echo $usr; ?>&app=<?php echo $app; ?>&back=1" />
</map></td>
</tr>
  <tr>
    ...
     <div style="margin-left:5px;">
      <table width="100%" border="0">
        <tr>
          <td><?php include ('internet/knowledge_economy/Knowledge_economy_Wikipedia.php');?>&nbsp;</td>
        </tr>
      </table></div></td>
  </tr>
  <tr>
