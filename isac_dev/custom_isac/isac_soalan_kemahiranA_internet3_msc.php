...
<table width="100%" border="0" align="center" bgcolor="#F3F4F6">
  ...
  <tr>
    <td width="100%" colspan="3"><img src="internet/MSC/msc_header.png" width="1364" height="96" /></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" > <?php include ('internet/MSC/Multimedia_Super_Corridor_Google_Search.php');
	
											?>&nbsp;</td>
  </tr>
</table>
</div>
<div style="margin-top:-15px; position:absolute; height:-17px; top:38px; left:10px;">
