...
<table width="100%" border="0">
  ...
  <tr>
    <td height="252" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="5%" height="71" class="style3">&nbsp;</td>
    <td width="4%" class="style3">&nbsp;</td>
    <td width="41%" class="style3"><div align="left"></div></td>
    <td width="41%" class="style3"><div align="right">
      <p class="style41">&nbsp;<img src="image/SignDrM.JPG" width="135" height="95" /></p>
      </div></td>
    <td width="3%" class="style3">&nbsp;</td>
    <td width="6%" class="style36">&nbsp;</td>
  </tr>
  <tr>
    <td height="38" class="style3">&nbsp;</td>
    <td colspan="2" class="style3"> <div align="right" class="style38">
      <div align="left" class="style39"></div>
    </div></td>
    <td colspan="2" class="style37"><div align="right" class="style39">DR. MAZLAN BIN HARUN</div></td>
    <td class="style3">&nbsp;</td>
  </tr>
</table>
