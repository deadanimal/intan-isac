...
$query = "SELECT COUNT(id_sesi) AS numrows FROM usr_isac.pro_sesi where kod_kategori_peserta='02' and year(tarikh_sesi)='".$currentYear."' ";
$result = mysql_query($query) or die('Error, query failed');
