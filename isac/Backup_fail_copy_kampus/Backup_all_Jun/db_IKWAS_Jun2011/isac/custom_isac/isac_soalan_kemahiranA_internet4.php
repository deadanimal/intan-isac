...
<body>
  <tr>
    <td colspan="3"><img src="image/wiki_header_full.png" width="1366" height="93" border="0" usemap="#Map" />
<map name="Map" id="Map">
  <area shape="rect" coords="3,0,33,34" href="isac_soalan_kemahiranA_internet3.php?id=<?php echo $usr; ?>&app=<?php echo $app; ?>&back=1" />
</map></td>
  </tr>
  <tr>
    ...
     
      <table width="100%" border="0">
        <tr>
          <td><?php include ('wikipedia.php');?>&nbsp;</td>
        </tr>
      </table></td>
  </tr>
  <tr>
