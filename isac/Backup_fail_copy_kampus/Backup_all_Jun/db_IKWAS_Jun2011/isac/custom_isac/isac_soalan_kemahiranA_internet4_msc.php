...
<body>
  <tr>
    <td colspan="3"><img src="internet/MSC/msc_header2.png" width="100%" height="93" border="0" usemap="#Map" />
<map name="Map" id="Map">
<area shape="rect" coords="3,0,33,34" href="isac_soalan_kemahiranA_internet3_msc.php?id=<?php echo $usr; ?>&app=<?php echo $app; ?>&back=1" />
</map></td>
  </tr>
  <tr>
    ...
     <div style="margin-left:5px;">
      <table width="100%" border="0">
        <tr>
          <td><?php include ('internet/MSC/MSC_Malaysia_Wikipedia.php');?>&nbsp;</td>
        </tr>
      </table></div></td>
  </tr>
  <tr>
