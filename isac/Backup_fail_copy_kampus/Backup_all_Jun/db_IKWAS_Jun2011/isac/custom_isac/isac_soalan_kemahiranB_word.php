...
$sql_check = "select * from usr_isac.prs_penilaian_peserta_kemahiran where id_peserta = '".$id_peserta."' and id_permohonan = '".$app."' and kod_bahagian_soalan='02'";
$result_check = $myQuery->query($sql_check,'SELECT');
	...
	$sql = "insert into usr_isac.prs_penilaian_peserta_kemahiran (id_peserta,id_permohonan,fail_jawapan_peserta,kod_bahagian_soalan,status_push_pull) values ('".$id_peserta."','".$app."','".$ans_file."','02','I')";
...
obj=w.Documents.Open("\\\\<?php echo $location;?>\\htdocs\\isac\\custom_isac\\kemahiran\\<?php echo $fileDest;?>"); 
}
//this.close();
</script>
</head>
