...
{
//outlook
windowOne=window.open('isac_outlook.php?id=<?php echo $usr;?>&app=<?php echo $app;?>','answer','height=490,width=1024,left=0,top=0, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
//outlook_question
windowTwo=window.open('isac_soalan_kemahiranC2.php?id=<?php echo $usr;?>&app=<?php echo $app;?>','question','height=200,width=1024,left=0,top=640, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
}
</script>
</head>
