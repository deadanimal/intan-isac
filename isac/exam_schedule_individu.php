...
$query = "SELECT (SELECT description1 FROM refgeneral 
				...
				FROM usr_isac.pro_sesi 
				WHERE kod_kategori_peserta='01' 
				and id_sesi !='351' and id_sesi !='395' 
				and year(tarikh_sesi)='".$currentYear."'
				ORDER BY tarikh_sesi DESC,kod_sesi_penilaian ASC LIMIT $offset, $rowsPerPage";
  ...
  <tr>
    <td><table width="664" border="0">
      ...
      <tr>
        ...
        <td width="637"><span class="style75">JADUAL PENILAIAN ISAC (INDIVIDU)</span></td>
<?php
...
<table width="95%" height="78" align="center" bordercolor="#F29422">
  <tr bgcolor="#086092">
    <td width="20" height="21" background="img/content/header_bar1.jpg" bgcolor="#086092" class="style50"><div align="center" class="style1 style56 style59">
        <div align="center" class="style77">Bil.</div>
    </div></td>
  ...
  <tr bgcolor="<?php echo $color; ?>" >
    ...
    <td height="22" class="style2 style64 style67"><div align="center"><?php echo $data['SESI']; ?>&nbsp; </div>
  ...
  <tr >
    <td height="25" colspan="6" class="style16 style64  style76"><?php

$query = "SELECT COUNT(id_sesi) AS numrows FROM usr_isac.pro_sesi where kod_kategori_peserta='01' and id_sesi !='351' and id_sesi !='395' and year(tarikh_sesi)='".$currentYear."'";
$result = mysql_query($query) or die('Error, query failed');
