...
<table width="50%">
  <tr>
    <td width="11%"><span class="style1">To IAC :</span></td>
    <td width="89%">
      <span class="style2">
...
<p>&nbsp;</p>
<label></label>
<input type="button" name="button" id="button" value="Push" onclick="window.location='push_peserta.php?iac=<?php echo $iac;?>'" />
