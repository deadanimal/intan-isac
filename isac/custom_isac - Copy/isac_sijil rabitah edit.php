...
<table width="100%" border="0">
  ...
  <tr>
    <td height="243" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="6" class=""><div align="center" class="style36"><?php echo $newdate.' '.$newmonth.' '.$newyear; ?> </div></td>
  </tr>
  <tr>
    <td height="52" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr>
    <td width="4%" class="style3">&nbsp;</td>
    <td width="4%" class="style3">&nbsp;</td>
    <td width="40%" class="style3"><div align="left"></div></td>
    <td width="38%" class="style3"><div align="right"><br />
    </div></td>
    <td width="6%" class="style3">&nbsp;</td>
    <td width="5%" class="style36">&nbsp;</td>
  </tr>
  <tr>
    <td height="54" class="style3">&nbsp;</td>
