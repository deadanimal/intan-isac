...
$query = "SELECT a.id_peserta, a.id_permohonan, b.id_soalan, b.arahan_soalan,b.penyataan_soalan,c.kod_jenis_soalan,
...
//Applying pagination.
$pagination = pagination_array($arahan_soalan, $soalan, $kod, $id_soalan,"&usr=".$id_peserta."&app=".$id_permohonan."&submit=true", $page, "?page=");
...
//Kembali
if($page != 1){
echo '<span><a onclick="checkjawapan()" href="'.$pageURL.'/isac/custom_isac/soalan_perincian1.php?page='.$prev_page.'&submit=true&usr='.$id_peserta.'&app='.$id_permohonan.'"><< 
...
if($page != $last_page){
echo '&nbsp;&nbsp;&nbsp;&nbsp;<span><a 
href="'.$pageURL.'/isac/custom_isac/soalan_perincian1.php?page='.$next_page.'&submit=true&usr='.$id_peserta.'&app='.$id_permohonan.'">Seterusnya >></a></span>
&nbsp;&nbsp;';
}
echo '</div>';
?>
