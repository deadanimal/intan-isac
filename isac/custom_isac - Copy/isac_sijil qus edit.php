...
$nama = "select nama_peserta,no_kad_pengenalan from usr_isac.pro_peserta where no_kad_pengenalan = '$user' or no_kad_pengenalan_lain = '".$user."'";
$result = $myQuery->query($nama,'SELECT');
$nama = $result[0][0];
$no_kad_pengenalan = $result1[0][1];
