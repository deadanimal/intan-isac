...
//get id_permohonan
$get_mohon = "select id_permohonan from usr_isac.prs_permohonan where id_peserta = '$ic_peserta' and tarikh_permohonan = (select max(tarikh_permohonan) from usr_isac.prs_permohonan where id_peserta = '$ic_peserta')";
...
self.parent.location = '../index.php?page=page_wrapper&menuID=6268&id='+idpeserta;
}
