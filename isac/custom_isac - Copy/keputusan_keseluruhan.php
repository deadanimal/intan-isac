...
$mohon = "select max(a.id_permohonan) from usr_isac.prs_permohonan a,usr_isac.pro_peserta b where a.id_peserta=b.id_peserta and (b.no_kad_pengenalan='".$ic."' or b.no_kad_pengenalan_lain='".$ic."') and a.id_sesi='".$sesi."' ";
...
?>
         ...
         <p align="right">
       <input type="submit" onclick="javascript:pop('custom_isac/keputusan_keseluruhan_cetak.php?id_sesi=<?php echo $_GET['id_sesi'];?>');" name="button" id="button" value="Cetak" />
     </p></td>
   </tr>
 </table>
</body>
