...
/**
TO CHECK IF DROPDOWN HAVE VALUE
-elem: element of the dropdown
*/
...
{	
	...
	{ 
		...
		document.getElementById("deleteCat").disabled = false;
			
		document.getElementById("showList").style.color = '#000000'; 
		document.getElementById("editCat").style.color = '#000000';  
		document.getElementById("deleteCat").style.color = '#000000'; 
	} 
	else 
	{	
		document.getElementById("showList").disabled = true; 
		document.getElementById("editCat").disabled = true; 
		document.getElementById("deleteCat").disabled = true;
		
		document.getElementById("showList").style.color = '#999999'; 
		document.getElementById("editCat").style.color = '#999999';  
		document.getElementById("deleteCat").style.color = '#999999';
	}
}
