...
class Paginator{
	...
	function paginate()
	{
		...
		{
			$this->return = ($this->current_page != 1 And $this->items_total >= 10) ? "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$prev_page&ipp=$this->items_per_page$this->querystring\">&laquo; Sebelum</a> ":"<span class=\"inactive\" href=\"#\">&laquo; Sebelum</span> ";
			...
			$this->return .= (($this->current_page != $this->num_pages And $this->items_total >= 10) And ($_GET['page'] != 'All')) ? "<a class=\"paginate\" href=\"$_SERVER[PHP_SELF]?page=$next_page&ipp=$this->items_per_page$this->querystring\">Seterusnya &raquo;</a>\n":"<span class=\"inactive\" href=\"#\">&raquo; Seterusnya</span>\n";
