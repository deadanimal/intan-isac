...
<table width="100%" border="0">
  ...
  <tr valign="top">
    <td height="310" colspan="6"><p>&nbsp;</p></td>
  </tr>
  
  <tr valign="top">
    <td height="100" colspan="6" class="style3"><div align="center"> 
      <p class="style28"><?php echo $nama;?><br />
        <?php if (strlen($user)==12) 
	  		{
		echo substr($user, 0, -6);
		echo '-';
		echo substr($user, 6, -4); 
		echo '-';
		echo substr($user, 8);}
			else echo $user;// returns "abcde"?>
</p>
</div></td>
  </tr>
  <tr valign="top">
    <td height="220" colspan="6" class="style3">&nbsp;</td>
  </tr>
  <tr valign="top">
  ...
  <tr>
    ...
    <td width="1%">&nbsp;</td>
    <td width="40%"><div align="left"><img src="image/TTPI.jpg" width="240" height="120" alt="PIsign" /></div></td>
    <td width="46%" valign="bottom"><div align="right">
      <p><img src="image/SignKKiIMATEC.jpg" width="180" height="95" alt="" /></p>
    </div></td>
    <td width="2%">&nbsp;</td>
    <td width="7%">&nbsp;</td>
  </tr>
  <tr>
    <td height="38" valign="top" class="style39">&nbsp;</td>
    <td colspan="2" valign="top" class="style3"> <div align="right" class="style38">
      <div align="left" class="style37">        DATO' DR. MAZLAN BIN YUSOFF</div>
    </div></td>
    <td colspan="2" valign="top" class="style37"><div align="right" class="style39">
      <div align="right" class="style38">DATO' DR. ZAHARI BIN OTHMAN </div>
    </div></td>
    <td class="style3">&nbsp;</td>
  </tr>
</table>
