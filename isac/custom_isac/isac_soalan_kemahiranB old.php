    ...
    <td height="29"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
      ...
      <tr>
        <td><div align="right" class="style34 style17 style35" id="userNotification3"><strong><span class="style36">* Sila pilih samada menjawab soalan </span>&nbsp;&nbsp;
         ...
         <strong>
         <input style="margin-right:3px" onclick="javascript:pop('isac_soalan_kemahiranB_word.php?id=<?php echo $usr;?>&app=<?php echo $app;?>');" type="button" value="Microsoft Word" class="inputButton" />
       ...
       <input style="margin-right:3px" onclick="javascript:pop('isac_soalan_kemahiranB_power_point.php?id=<?php echo $usr;?>&app=<?php echo $app;?>');" type="button" value="Microsoft PowerPoint" class="inputButton" /></div>
        <p></p>
        <div id="userNotification3" align="right"><span class="style37">* Nota : Anda hanya boleh menjawab Bahagian C setelah selesai Bahagian  B (Word).</span>
          <input style="margin-right:3px" onclick="confirmation()" type="button" value="Bahagian C" class="inputButton" />
        </div></td>
      </tr>
    </table></td>
  </tr>
