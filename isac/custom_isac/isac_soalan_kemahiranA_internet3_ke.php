...
<table width="100%" border="0" align="center" bgcolor="#F3F4F6">
  ...
  <tr>
    <td width="100%" colspan="3"><img src="internet/knowledge_economy/KE_header.png" width="1365" height="91" /></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" > <?php include ('internet/knowledge_economy/Knowledge_Economy_Google_Search.php');
