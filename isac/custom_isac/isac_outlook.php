...
<tr>
<td>
<table width="939" border="0" background="../img/outlook/bottom.png"><form id="form1" name="form1" method="post" action="isac_outlook2.php?id=<?php echo $_GET['id']; ?>&app=<?php echo $_GET['app']; ?>">
<tr> 
...
<td><div align="left" style="margin-top:-1px;"><label>
  <input name="to" type="text" id="to" size="100" />
  <br />
  <input name="cc" type="text" id="cc" size="100" />
  <br />
  <input name="subject" type="text" id="subject" size="100" />
  <br />
   <input type="text" id="mine" name="mine" size="100" readonly="true">
...
<tr>
  <td colspan="3"><div align="left" style="margin:6px;"><textarea name="mesej" id="mesej" cols="85" rows="15"></textarea>
  </div></td>
  </tr>
 <tr>
 <td colspan="1"></td></tr>
