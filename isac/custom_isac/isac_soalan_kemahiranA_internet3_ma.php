...
function exit() {
window.close('isac_soalan_kemahiranA_internet3_ma.php');
}
...
<table width="100%" border="0" align="center" bgcolor="#F3F4F6">
  ...
  <tr>
    <td width="100%" colspan="3"><img src="internet/mobile_application/ma_header.png" width="1365" height="91" /></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF" > <?php include ('internet/mobile_application/Technology_Google_Search.php'); ?>&nbsp;</td>
  </tr>
</table>
</div>
