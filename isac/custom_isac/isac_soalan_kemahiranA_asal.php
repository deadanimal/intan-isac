...
op.focus();
	  ...
	  function confirmation() 
	  {
		...
		if (answer)
		{
			window.location.href = "isac_soalan_kemahiranB.php?id=<?php echo $usr;?>";
		}
...
{
//mock_internet
windowOne=window.open('isac_soalan_kemahiranA_internet1.php?id=<?php echo $usr;?>','answer','height=490,width=1024,top=0, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
//solan_internet
windowTwo=window.open('isac_soalan_kemahiranA_internet.php?id=<?php echo $usr;?>','question','height=200,width=1024,left=0,top=640, scrollbars=1, resizable=0,menubar=0,toolbar=0,location=0,status=0,statusbar=0');
...
<table id="tableContent" cellspacing="0" cellpadding="0" border="0" width="100%">
   ...
   <input style="margin-right:3px" onclick="displaymessage()" type="button" value="Internet Explorer" class="inputButton" />
         </div>
         <p>
         </p>
